...
::icon::Icon IconProvider::coreIcon(IconRole role)
{
	switch (role)
	{
	case IconRole::ThemeSun: return ::icon::Icon::ANT_ThemeSun;
	case IconRole::ThemeMoon: return ::icon::Icon::ANT_ThemeMoon;
	case IconRole::WindowMin: return ::icon::Icon::ANT_WindowMin;
	case IconRole::WindowMax: return ::icon::Icon::ANT_WindowMax;
	case IconRole::WindowClose: return ::icon::Icon::ANT_WindowClose;
	case IconRole::WindowRestore: return ::icon::Icon::ANT_WindowRestore;
	case IconRole::NavHome: return ::icon::Icon::ANT_NavHome;
	case IconRole::NavHomeActive: return ::icon::Icon::ANT_NavHomeActive;
	case IconRole::NavFunction: return ::icon::Icon::ANT_NavFunction;
	case IconRole::NavFunctionActive: return ::icon::Icon::ANT_NavFunctionActive;
	case IconRole::NavSettings: return ::icon::Icon::ANT_NavSettings;
	case IconRole::NavSettingsActive: return ::icon::Icon::ANT_NavSettingsActive;
	case IconRole::NavAbout: return ::icon::Icon::ANT_NavAbout;
	case IconRole::NavAboutActive: return ::icon::Icon::ANT_NavAboutActive;
	case IconRole::MsgInfo: return ::icon::Icon::ANT_MsgInfo;
	case IconRole::MsgSuccess: return ::icon::Icon::ANT_MsgSuccess;
	case IconRole::MsgError: return ::icon::Icon::ANT_MsgError;
	case IconRole::MsgWarning: return ::icon::Icon::ANT_MsgWarning;
	case IconRole::AvatarGuest: return ::icon::Icon::ANT_AvatarGuest;
	case IconRole::BrandGithub: return ::icon::Icon::ANT_BrandGithub;
	case IconRole::Back: return ::icon::Icon::ANT_Back;
	case IconRole::TabClose: return ::icon::Icon::ANT_TabClose;
	case IconRole::Search: return ::icon::Icon::ANT_Search;
	case IconRole::Prev:
	case IconRole::PrevDisabled: return ::icon::Icon::ANT_Prev;
	case IconRole::Next:
	case IconRole::NextDisabled: return ::icon::Icon::ANT_Next;
	case IconRole::ArrowUp: return ::icon::Icon::ANT_ArrowUp;
	case IconRole::ArrowDown: return ::icon::Icon::ANT_ArrowDown;
	case IconRole::ArrowRight: return ::icon::Icon::ANT_ArrowRight;
	case IconRole::ArrowRightSmall: return ::icon::Icon::ANT_ArrowRightSmall;
	case IconRole::NoData: return ::icon::Icon::ANT_NoData;
	case IconRole::GoTo: return ::icon::Icon::ANT_GoTo;
	case IconRole::Eye: return ::icon::Icon::ANT_Eye;
	case IconRole::EyeSlash: return ::icon::Icon::ANT_EyeSlash;
	case IconRole::CarouselArrow: return ::icon::Icon::ANT_CarouselArrow;
	case IconRole::None:
	default:
