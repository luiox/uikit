	...
	: QWidget(parent)
{
	...
	QLabel* title = new QLabel(QStringLiteral("libant-qt demo"), this);
	QFont titleFont;
	...
	QLabel* desc = new QLabel(QStringLiteral("This demo window has been split out of libant-qt and is now built independently with xmake."), this);
